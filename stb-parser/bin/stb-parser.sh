...
hadoop jar $(cd "$(dirname "$0")"; pwd)/tools-1.0-SNAPSHOT.jar -I /icntv/parser/stb/cdnAdapter/middle/$day/ -Out /icntv/parser/stb/cdnAdapter/result/$day/cdnloginfo_$day1.dat
