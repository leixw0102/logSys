 ...
 * Time: 10:00
 */
public class EPGOperateMapper2 extends Mapper<LongWritable,Text,NullWritable,Text> implements EPGOperate {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        if(PAGE_NAME_PANEL.equalsIgnoreCase(StringUtils.substringAfter(contentArr[0].trim(), EQUAL_SIGN))){
            ...
            //--2.PageName
            resultBuffer.append(StringsUtils.getEncodeingStr("EPGSearch")).append(SPLIT);
            //--3.targetObjectType:1.panel页面,2.节目集详情页,3.栏目,4.面板项,5.网动版首页 (推荐位或列表位)  6．搜索  7.历史记录  8.专题  99.其他
